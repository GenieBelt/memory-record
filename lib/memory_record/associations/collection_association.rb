module MemoryRecord
  module Associations
    # = Memory Record Association Collection
    #
      ...
      def take(n = nil)
        if loaded?
          ...
          scope.take(n).tap do |record|
            set_inverse_instance record if record.is_a? MemoryRecord::Base
          end
        end
      end
      ...
      def get_records
        ...
        def _create_record(attributes, raise = false, &block)
          unless owner.persisted?
            raise MemoryRecord::RecordNotSaved, "You cannot call create unless the parent is saved"
          end
        ...
        def include_in_memory?(record)
          if reflection.is_a?(MemoryRecord::Reflection::ThroughReflection)
