...
module MemoryRecord
  module Associations
    # Keeps track of table aliases for MemoryRecord::Associations::JoinDependency
      ...
      def self.initial_count_for(connection, name, table_joins)
        ...
        counts = table_joins.map do |join|
          if join.is_a?(Arel::Nodes::StringJoin)
            ...
            join.left.store_name == name ? 1 : 0
          else
            # this branch is reached by two tests:
            #
            # MemoryRecord/test/cases/associations/cascaded_eager_loading_test.rb:37
            #   with :posts
            #
            # MemoryRecord/test/cases/associations/eager_test.rb:1133
            #   with :comments
            #
            0
          end
